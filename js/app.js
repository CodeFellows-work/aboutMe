...
let fromWhere = prompt('So ' + userName + ', do I live in Washington? Answers must be yes or no');
...
//Question 2
let doStudy = prompt('Do you think I like to study, ' + userName + '?' + ' Answer yes or no.');
...
while(attempts > 0){
  let guessMySupplement = prompt('Hello ' + userName + ' What do you think one of my favorite supplements are?');
